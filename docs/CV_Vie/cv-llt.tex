...
\leftheader{%
  {\fontsize{20}{22}\selectfont\bfseries Trần Công Minh} \\
  {\Large \textbf{Cử nhân Kỹ thuật Phần mềm | Tư duy Hệ thống \& Giải quyết Vấn đề}} \\  
  \vspace{0.5em}
  \begin{tabular}{@{} ll @{\hspace{1cm}} ll @{}}
    ...
    \makefield{\faMapMarker}{Bình Đông, TP.HCM}
  \end{tabular}
}
