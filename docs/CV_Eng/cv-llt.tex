...
\leftheader{%
  {\fontsize{20}{22}\selectfont\bfseries Tran Cong Minh} \\
  {\Large \textbf{B.S. Software Engineering | Problem-Solving \& Systems Thinking}} \\  
  \vspace{0.5em}
  \begin{tabular}{@{} ll @{\hspace{1cm}} ll @{}}
    \makefield{\faPhone}{\!\! (+84) 777 999 496} &
    \makefield{\faEnvelope[regular]}{\href{mailto:tcongminh1604@gmail.com}{tcongminh1604@gmail.com}} \\
    \makefield{\faGithub}{\href{https://github.com/dexter826}{github.com/dexter826}} &
    \makefield{\faGlobe}{\href{https://mob-portfolio-sand.vercel.app/}{mob-portfolio-sand.vercel.app}} \\
    \makefield{\faCalendar}{09/03/2004} &
    \makefield{\faMapMarker}{Ward Binh Dong, HCMC}
  \end{tabular}
}
...
\makerubric{projects}
\makerubric{work-experience}

% If you're not a researcher nor an academic, you probably don't have any publications; delete this line.
% \input{publications}  % Comment out or delete this line to remove Publications

\makerubric{skills}
% \makerubric{misc}      % Comment out or delete this line to remove Miscellaneous Experience
% \makerubric{referee}   % Comment out or delete this line to remove References
% \input{referee-full}
