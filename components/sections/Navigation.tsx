...
export function Navigation() {
  return (
    <header className="sticky top-0 z-50 bg-background/80 backdrop-blur-md flex justify-between items-center px-6 sm:px-12 py-8 border-b border-border-subtle shrink-0">
